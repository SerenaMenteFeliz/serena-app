...
// riscado uma vez, pra R$29,90). Turma fundadora: sobe depois, sem data
// fixa ainda. Ver Método Cálice - Visão Geral no vault.
export const PRODUCT_PRICE: Record<ProductSlug, { value: number; label: string }> = {
  metodo_calice: { value: 29.9, label: "Método Cálice" },
